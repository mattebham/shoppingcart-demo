...
public class OrderServiceTest {
    ...
    public void shouldFindAllOrders() {
        ...
        OrderInfoList actual = orderService.findAllOrders();
    ...
    public void shouldCreateOrder() {
        ...
        String createdOrderId = orderService.createOrder(new OrderInfo(null, newArrayList(new OrderLine(new Product("1", "p1"), 1))));
    ...
    public void shouldUpdateOrder() {
        ...
        orderService.updateOrder(new OrderInfo("1", newArrayList(new OrderLine(new Product("1", "p1"), 1))));
    ...
    public void shouldThrowExceptionIfIdIsNullWhileUpdatingOrder() {
        ...
        try {
            orderService.updateOrder(new OrderInfo(null, newArrayList(new OrderLine(new Product("1", "p1"), 1))));
